...
if len(sys.argv) != 5:
    print(
        "Example execution:\n"
        "    ./shape_predictor_single.py t-shirts/pullandbear/detector.svm t-shirts/pullandbear/predictor.dat ../dataset/t-shirts/pullandbear/products/5237502800_2_1_2/5237502800_2_1_2.jpg ../dataset/t-shirts/CROPPED/")
    exit()
